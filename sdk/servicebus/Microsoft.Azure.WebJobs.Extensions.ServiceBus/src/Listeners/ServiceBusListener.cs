    ...
    internal sealed class ServiceBusListener : IListener, IScaleMonitorProvider
    {
            ...
            ConcurrencyManager concurrencyManager)
        {
            ...
            if (concurrencyManager.Enabled)
            {
                ...
                _concurrencyUpdateManager = new ConcurrencyUpdateManager(concurrencyManager, _messageProcessor, _sessionMessageProcessor, _isSessionsEnabled, _functionId);
            }
        ...
        private void UpdateConcurrency(object state)
        {
            try
            {
                _concurrencyUpdateManager.UpdateConcurrency();
            }
            catch (Exception ex)
            {
...
#pragma warning restore AZC0102 // Do not use GetAwaiter().GetResult().
        ...
        /// </summary>
        internal class ConcurrencyUpdateManager
        {
            ...
            public ConcurrencyUpdateManager(ConcurrencyManager concurrencyManager, Lazy<MessageProcessor> messageProcessor, Lazy<SessionMessageProcessor> sessionMessageProcessor, bool sessionsEnabled, string functionId)
            {
