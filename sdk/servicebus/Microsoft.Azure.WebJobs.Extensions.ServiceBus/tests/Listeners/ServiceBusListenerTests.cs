...
namespace Microsoft.Azure.WebJobs.ServiceBus.UnitTests.Listeners
{
    public class ServiceBusListenerTests
    {
        ...
        public void ConcurrencyUpdateManager_UpdatesProcessorConcurrency()
        {
            ...
            ServiceBusListener.ConcurrencyUpdateManager concurrencyUpdateManager = new ServiceBusListener.ConcurrencyUpdateManager(concurrencyManager, messageProcessor, null, false, _functionId);
        ...
        public void ConcurrencyUpdateManager_Sessions_UpdatesProcessorConcurrency()
        {
            ...
            ServiceBusListener.ConcurrencyUpdateManager concurrencyUpdateManager = new ServiceBusListener.ConcurrencyUpdateManager(concurrencyManager, null, sessionMessageProcessor, true, _functionId);
